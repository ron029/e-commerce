...
?>
		...
		<div class="admin_order_info_status">
			...
			<aside>
				...
				<span><p>Shipping: </p><p
						class="shipping">P <?= number_format($order['shipping_fee'] + 147, 2) ?></p></span>
				<span><p>Total Price: </p><p
						class="total_price">P <?= number_format(($order['carts_total_price'] + 150), 2) ?></p></span>
			</aside>
		</div>
	</aside>
</main>
